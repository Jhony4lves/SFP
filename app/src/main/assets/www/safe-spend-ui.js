(function(global){
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      .safe-spend-eyebrow{font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.055em;color:var(--color-text-muted)}
      ...
      .safe-spend-equation small{display:block;color:var(--color-text-muted);font-size:11px;text-transform:uppercase;font-weight:750}
      ...
      .safe-spend-projection-head small{display:block;font-size:11px;color:var(--color-text-secondary);margin-top:2px}
      .safe-spend-min{font-size:11px;text-align:right;color:var(--color-text-secondary)}
      ...
      .safe-spend-event{display:grid;grid-template-columns:70px minmax(0,1fr) auto;gap:8px;align-items:center;padding:7px 8px;border-radius:9px;background:var(--color-surface-elevated);border:1px solid var(--color-border);font-size:11px}
      ...
      .safe-spend-foot p{margin:0;color:var(--color-text-secondary);font-size:11px;line-height:1.45;max-width:720px}
      .safe-spend-foot button{min-height:44px;padding:8px 10px;font-size:11px;flex:0 0 auto}
