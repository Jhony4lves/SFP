...
test('#163 financialContextSnapshot não chama competência pendente de realizado', async ({ page }) => {
  ...
  value.transactions = [
    { id:16301, accountId:1, kind:'income', amount:500, date:'2026-02-01', status:'paid', balanceImpact:true, desc:'Receita recebida', category:'Trabalho' },
    { id:16302, accountId:1, kind:'expense', amount:70, date:'2026-02-10', status:'pending', balanceImpact:false, desc:'Despesa apenas por competência', category:'Casa' }
  ];
  ...
  expect(result.snapshot).toEqual({ incomeCents:50000, expenseCents:0, resultCents:50000 });
...
test('#164 transferência futura para Reserva não conta como poupança realizada', async ({ page }) => {
  ...
  value.accounts = [
    { id:1, name:'Conta corrente', type:'Conta corrente', initial:1000, balanceMode:'snapshot', balanceDate:'2098-12-31' },
    { id:2, name:'Reserva', type:'Reserva', initial:0, balanceMode:'snapshot', balanceDate:'2098-12-31' }
  ];
  value.transfers = [{ id:16401, desc:'Aporte agendado', amount:500, date:'2099-01-20', fromId:1, toId:2, balanceImpact:false }];
...
test('#164 não conta Reserva para Investimento como nova poupança', async ({ page }) => {
  const value = fixture('QA issue 164 protected transfer');
  value.mesAtual = '2000-01';
  value.accounts = [
    { id:1, name:'Conta', type:'Conta corrente', initial:1000 },
    { id:2, name:'Reserva', type:'Reserva', initial:0 },
    { id:3, name:'Investimentos', type:'Investimento', initial:0 }
  ];
  value.transfers = [
    { id:16411, amount:100, date:'2000-01-10', fromId:1, toId:2, balanceImpact:true },
    { id:16412, amount:100, date:'2000-01-11', fromId:2, toId:3, balanceImpact:true }
  ];
